...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        console.log('coinbaseBuffer: ' + util.reverseBuffer(coinbaseBuffer).toString('hex'));
        console.log('merkleRoot: ' + merkleRoot);
        console.log('headerBuffer: ' + util.reverseBuffer(headerBuffer).toString('hex'));
        console.log('headerHash: ' + util.reverseBuffer(headerHash).toString('hex'));
